...
class TensorData:
    ...
    def indices(self) -> Iterable[UserIndex]:
        ...
        This method yields each index as a tuple, allowing iteration over all
        positions in the tensor. The indices are generated in a sequential order
        such that they correspond to the flattened order of the tensor.
        Returns:Iterable[UserIndex]: An iterable of tuples, where each tuple represents a valid index into the tensor.
        Example:For a tensor with shape (2, 3), the indices generated would be:(0, 0), (0, 1), (0, 2), (1, 0), (1, 1), (1, 2).
        """
    ...
    def get(self, key: UserIndex) -> float:
        """Get a value from the tensor by index."""
        x: float = self._storage[self.index(key)]
        return x

    def set(self, key: UserIndex, val: float) -> None:
        """Set a value in the tensor by index."""
